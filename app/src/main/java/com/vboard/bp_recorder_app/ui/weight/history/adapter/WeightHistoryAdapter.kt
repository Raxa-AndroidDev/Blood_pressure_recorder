package com.vboard.bp_recorder_app.ui.weight.history.adapter
...
class WeightHistoryAdapter(var context: Context, var callBacks: ShowWeightAdapterCallbacks) :
    ...
    var weighttype: String = Constansts.bp_Normal
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            weighttype = getWeightType((currentItem.weight/ (currentItem.height*currentItem.height)).toDouble())
